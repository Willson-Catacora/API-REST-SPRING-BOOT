...
import med.voll.api.models.paciente.DatosRegistroPaciente;
...
class MedicoRepositorioTest {
    ...
    void elegirMedicoAleatorioDisponibleEnLaFechaEscenario1() {
        ...
        //when o act
        var medicoLibre = medicoRepositorio.elegirMedicoAleatorioDisponibleEnLaFecha(Especialidad.CARDIOLOGIA, lunesSiguienteALas10);
        //then o assert
